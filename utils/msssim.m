function overall_mssim = msssim(img1, img2, max_val, K, win, level, weight, method)
...
im2 = double(img2);
for l = 1:level
   [mssim_array(l) ssim_map_array{l} mcs_array(l) cs_map_array{l}] = ssim_index_new(im1, im2, K, win, max_val);
%   [M N] = size(im1);
